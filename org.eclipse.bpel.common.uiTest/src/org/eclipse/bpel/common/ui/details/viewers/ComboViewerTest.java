...
/**
 * The class <code>ComboViewerTest</code> contains tests for the class <code>{@link ComboViewer}</code>.
 *
...
public class ComboViewerTest {
	/**
	 * Run the ComboViewer(Combo) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 14/10/19 22:30
	 */
	@Test
	public void testComboViewer_1()
		throws Exception {
		Combo combo = new Combo(new Composite(new Composite((Composite) null, 0), 1), 1);

		ComboViewer result = new ComboViewer(combo);
	...
	/**
	 * Run the ComboViewer(Composite) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 14/10/19 22:30
	...
	/**
	 * Run the ComboViewer(Composite,int) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 14/10/19 22:30
	...
	public void testAdd_1()
		throws Exception {
		ComboViewer fixture = new ComboViewer(new Combo(new Composite(new Composite((Composite) null, 0), 1), 1));
	...
	/**
	 * Run the Combo getCombo() method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 14/10/19 22:30
	 */
	@Test
	public void testGetCombo_1()
		throws Exception {
		ComboViewer fixture = new ComboViewer(new Combo(new Composite(new Composite((Composite) null, 0), 1), 1));

		Combo result = fixture.getCombo();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(ComboViewerTest.class);
	}
}